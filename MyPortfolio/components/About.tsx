      ...
      <div className="grid lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <motion.div
            ...
            className="space-y-6 text-base md:text-lg text-white/80 leading-relaxed"
          >
            <p>
            ...
            <div className="space-y-2 pt-4">
              <p className="font-bold text-white text-lg">My Philosophy:</p>
            ...
            <p className="text-lg md:text-2xl font-bold text-white underline decoration-violet-500/50">
              Building secure, intelligent, and impactful digital solutions.
            </p>
          </motion.div>

          {/* My Resume Section with Hover Reveal */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.3 }}
            className="group relative max-w-md p-5 rounded-3xl glass border border-white/5 bg-black/20 backdrop-blur-xl hover:border-violet-500/30 transition-all duration-500 overflow-hidden"
          >
            {/* Header Content (Always visible) */}
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                  <FileText className="w-6 h-6 animate-pulse" />
                </div>
                <div>
                  <span className="text-[10px] font-black uppercase tracking-widest text-white/40 block">My Resume</span>
                  <h3 className="text-lg font-bold text-white group-hover:text-violet-400 transition-colors duration-500">View / Download</h3>
                </div>
              </div>
              ...
              <div className="text-[10px] font-bold uppercase tracking-wider text-violet-400/60 group-hover:text-violet-400 group-hover:translate-x-1 transition-all duration-500 pr-1">
                <span className="group-hover:hidden">Hover to Access</span>
                <span className="hidden group-hover:inline">Select Action</span>
              </div>
            </div>

            {/* Hover Revealed Actions */}
            <div className="mt-0 h-0 opacity-0 overflow-hidden group-hover:mt-6 group-hover:h-20 group-hover:opacity-100 transition-all duration-500 ease-out grid grid-cols-2 gap-4">
              <a
                href="/Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center justify-center rounded-xl border border-white/5 bg-white/[0.02] hover:border-violet-500/30 hover:bg-violet-500/10 transition-all text-white/60 hover:text-white group/btn relative z-20 cursor-pointer"
              >
                <Eye className="w-5 h-5 text-violet-500 mb-1 group-hover/btn:scale-110 transition-transform" />
              ...
              <a
                ...
                className="flex flex-col items-center justify-center rounded-xl border border-white/5 bg-white/[0.02] hover:border-emerald-500/30 hover:bg-emerald-500/10 transition-all text-white/60 hover:text-white group/btn relative z-20 cursor-pointer"
              >
                <Download className="w-5 h-5 text-emerald-500 mb-1 group-hover/btn:scale-110 transition-transform" />
          ...
          >
            <a
              href="#contact"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold rounded-2xl hover:scale-105 transition-transform shadow-[0_10px_40px_-10px_rgba(249,115,22,0.5)] relative z-20"
            >
        ...
        <div className="lg:col-span-5 relative">
          ...
          >
            ...
            <span className="text-sm font-bold whitespace-nowrap">8.95 CGPA | Cyber Security</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-xs font-bold text-white/80">GIET, Rajahmundry</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-sm font-bold whitespace-nowrap">Cybersecurity Specialist</span>
          </motion.div>
